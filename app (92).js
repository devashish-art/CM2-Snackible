...
function viewTrends(){
  ...
  function drawMkt(){
    ...
    portals.forEach(function(p,pi){
      ...
      // Ads+Vis pane
      mkLine('c-adsv-'+p,av.labels,[
        {label:'Ads+Vis',data:av.data,borderColor:'#38BDF8',backgroundColor:'#38BDF822',fill:true,tension:0.35,pointBackgroundColor:'#38BDF8',pointRadius:4,pointHoverRadius:6,borderWidth:2.5}
      ],true,'%',isLast,'adsv',false,false);
      // Promos pane
      mkLine('c-promo-'+p,pr.labels,[
        {label:'Promos',data:pr.data,borderColor:col,backgroundColor:col+'22',fill:true,tension:0.35,pointBackgroundColor:col,pointRadius:4,pointHoverRadius:6,borderWidth:2.5}
      ],true,'%',isLast,'promo',false,false);
    });
  }
