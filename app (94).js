  ...
  function drawMkt(){
    ...
    portals.forEach(function(p,pi){
      ...
      var gmvShadowDs={
        ...
        fill:true,tension:0.35,pointRadius:0,borderWidth:1,order:3,
        yAxisID:'yGmv',
      ...
      destroy('c-adsv-'+p);var cv1=document.getElementById('c-adsv-'+p);if(cv1){
        ...
        opts1.plugins.tooltip.callbacks.label=function(ctx){
          if(ctx.dataset.yAxisID==='yGmv') return null;
          return ' '+ctx.dataset.label+': '+ctx.parsed.y.toFixed(1)+'%';
        };
        opts1.plugins.tooltip.callbacks.filter=function(item){return item.dataset.yAxisID!=='yGmv';};
      ...
      destroy('c-promo-'+p);var cv2=document.getElementById('c-promo-'+p);if(cv2){
        ...
        opts2.plugins.tooltip.callbacks.filter=function(item){return item.dataset.yAxisID!=='yGmv';};
