...
function sidebar() {
  ...
  return '<div class="sidebar"><div class="logo"><div class="logo-brand">Snackible</div><div class="logo-sub">QCom CM2</div></div><div class="sec-label">Views</div>'+nv('dashboard','📊','Dashboard')+nv('entry','➕','Enter Data')+nv('combined','🔀','Combined')+nv('trends','📈','Trends')+'<div class="sec-label">Portal</div><div class="portal-chips">'+cp('blinkit','🟡','Blinkit')+cp('zepto','🟠','Zepto')+cp('instamart','🔵','Instamart')+'</div><div class="sec-label">Links</div><a href="https://snackible-cm-2-projections.vercel.app/" target="_blank" style="text-decoration:none;display:block;padding:7px 12px;margin:2px 10px;border-radius:6px;font-size:12px;font-weight:600;color:rgba(255,255,255,.6);border:1.5px solid rgba(255,255,255,.15);transition:all .15s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,.6)'">🔮 CM2 Projections ↗</a></div>';
}
