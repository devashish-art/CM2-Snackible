...
function viewTrends(){
    ...
    chart.data.datasets.forEach(function(ds,di){
      ...
      meta.data.forEach(function(el,idx){
        ...
        if(isBar){
          ...
          var baseY=el.y-11;
          // Check if any existing label is within 16px vertically
          var conflict=posMap[key].some(function(ey){return Math.abs(ey-baseY)<16;});
          py=conflict?baseY+20:baseY;
          posMap[key].push(py);
        }
  ...
  function mkLine(id,labels,datasets,isPct,unit,showX,groupId,noTooltip){
  ...
  function drawMkt(){
    ...
    portals.forEach(function(p,pi){
      ...
      ],true,'%',pi===portals.length-1,'mkt',true);
    });
